...
class Test_Redact_Message_Other():
    ...
    def test_update_case_error01(self, startapp):
        test_update = Redact_Message_Other(startapp)
    ...
    def test_update_case_error02(self, startapp):
        test_update = Redact_Message_Other(startapp)
    ...
    def test_update_case_error03(self, startapp):
        test_update = Redact_Message_Other(startapp)
    ...
    def test_update_case_error04(self, startapp):
        test_update = Redact_Message_Other(startapp)
        test_update.update_nickname_error04()

        test_res = Redact_Message(startapp)
        res = test_res.get_nickname_success()
        exp = 'assassin'
        assert res != exp

    @allure.story("第五条用例: 点击性别后点击取消按钮")
    def test_update_case_error05(self, startapp):
        test_update = Redact_Message_Other(startapp)
    ...
    def test_update_case_error06(self, startapp):
        test_update = Redact_Message_Other(startapp)
    ...
    def test_update_case_error07(self, startapp):
        test_update = Redact_Message_Other(startapp)
