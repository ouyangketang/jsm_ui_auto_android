...
class Redact_Message(BaseApp):
    ...
    def update_case09(self,sex_text='男'):
        ...
        test = Redact_Message(self.driver)
        test.swipeUp()
        self.driver.find_element_by_xpath("//*[@text='广东省']").click()               # 择省份
        self.driver.find_element_by_xpath("//*[@text='深圳市']").click()
        self.driver.find_element_by_xpath("//*[@text='宝安区']").click()
        # 修改日期
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
    ...
    def update_case11(self,name='测试账号2', sex_text='男'):
        ...
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
        self.driver.swipe(start_x=35, start_y=791, end_x=366, end_y=1080)     # 年
        self.driver.swipe(start_x=100, start_y=791, end_x=523, end_y=889)      # 月
        self.driver.swipe(start_x=300, start_y=791, end_x=592, end_y=151)      # 日
        self.driver.find_element_by_xpath("//*[@text='确定']").click()
    ...
    def update_case14(self,name='新的昵称'):
        ...
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
        self.driver.swipe(start_x=400, start_y=791, end_x=499, end_y=1063)     # 年
        self.driver.swipe(start_x=300, start_y=791, end_x=600, end_y=999)      # 月
        self.driver.swipe(start_x=15, start_y=791, end_x=30, end_y=263)      # 日
        self.driver.find_element_by_xpath("//*[@text='确定']").click()
    ...
    def update_case16(self,name='点歌货我', sex_text='男'):
        ...
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
        self.driver.swipe(start_x=150, start_y=791, end_x=200, end_y=1080)     # 年
    ...
    def update_case17(self, sex_text='女'):
        ...
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
        self.driver.swipe(start_x=35, start_y=791, end_x=366, end_y=1080)     # 年
        self.driver.swipe(start_x=393, start_y=791, end_x=541, end_y=1151)      # 月
        self.driver.swipe(start_x=566, start_y=791, end_x=623, end_y=1151)      # 日
        self.driver.find_element_by_xpath("//*[@text='确定']").click()
        # 修改地址
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_get_region").click()       # 点击地址栏目
    ...
    def update_case18(self, sex_text = '男'):
        ...
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          #点击日期栏
        self.driver.swipe(start_x=100, start_y=791, end_x=566, end_y=1080)     # 年
        self.driver.swipe(start_x=390, start_y=791, end_x=523, end_y=889)      # 月
        self.driver.swipe(start_x=564, start_y=791, end_x=592, end_y=151)      # 日
        self.driver.find_element_by_xpath("//*[@text='确定']").click()
    ...
    def update_case19(self):
        ...
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
        self.driver.swipe(start_x=135, start_y=791, end_x=289, end_y=1019)  # 年
        self.driver.swipe(start_x=363, start_y=791, end_x=536, end_y=849)  # 月
        self.driver.swipe(start_x=510, start_y=791, end_x=587, end_y=154)  # 日
        self.driver.find_element_by_xpath("//*[@text='确定']").click()
        # 修改地址
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_get_region").click()       # 点击地址栏目
    ...
    def update_case20(self):
        ...
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
        self.driver.swipe(start_x=230, start_y=791, end_x=320, end_y=151)  # 年
        self.driver.swipe(start_x=363, start_y=791, end_x=536, end_y=154)  # 月
        self.driver.swipe(start_x=536, start_y=791, end_x=587, end_y=154)  # 日
        self.driver.find_element_by_xpath("//*[@text='确定']").click()
        # 修改地址
        self.wait()
    ...
    def update_case21(self):
        ...
        self.wait()
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_born").click()          # 点击日期栏
        self.driver.swipe(start_x=90, start_y=791, end_x=300, end_y=890)     # 年
    ...
    def update_case24(self):
        ...
        self.driver.find_element_by_xpath("//*[@text='东河区']").click()

    def update_case25(self, name='修改的昵称', sex_text='其它'):
        '''修改昵称、性别'''
        time.sleep(2)
        # 修改性别
        self.driver.find_element_by_id("com.jsmapp.jsm:id/ll_me_sex").click()           # 点击性别栏目
